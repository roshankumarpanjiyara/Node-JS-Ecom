...
// router.post('/add-category', authMiddleware.requireAuth, authMiddleware.requireAdmin, categoryController.rules.addCategory, categoryController.addCategory);
// router.get('/edit-category/:id', authMiddleware.requireAuth, authMiddleware.requireAdmin, categoryController.getEditCategory);
